...
import { buildArchitectDigest, collectArchitectPreferredPaths } from "@/server/ai/architect-digest";
import { AI_MODELS, SAFETY_SETTINGS } from "@/server/ai/constants";
import { buildStageContextPack } from "@/server/ai/context-manager";
import {
  DOC_SECTION_DEPENDENCIES,
  PRIMARY_DOC_TYPES,
  SECONDARY_DOC_TYPES,
} from "@/server/ai/doc-priority";
import {
  buildFallbackApiDocument,
  buildFallbackArchitecture,
  buildFallbackContributing,
  buildFallbackReadme,
} from "@/server/ai/fallback-docs";
import { unwrapAiText } from "@/server/ai/optimizers";
import {
...
import type { RepositoryEvidence } from "@/server/engine/core/types";
...
import { dumpDebug } from "../utils/debug-logger";
