...
const DropdownMenuSubMenuTrigger = forwardRef<
  ComponentRef<typeof DropdownMenuPrimitives.SubTrigger>,
  Omit<ComponentPropsWithoutRef<typeof DropdownMenuPrimitives.SubTrigger>, "asChild">
...
const DropdownMenuSubMenuContent = forwardRef<
  ComponentRef<typeof DropdownMenuPrimitives.SubContent>,
...
const DropdownMenuContent = forwardRef<
  ComponentRef<typeof DropdownMenuPrimitives.Content>,
...
const DropdownMenuItem = forwardRef<
  ComponentRef<typeof DropdownMenuPrimitives.Item>,
  Omit<ComponentPropsWithoutRef<typeof DropdownMenuPrimitives.Item>, "asChild"> & {
    shortcut?: string;
    hint?: string;
  }
>(({ className, shortcut, hint, children, ...props }, forwardedRef) => (
  ...
  >
    {children}
    {hint && (
      <span className={cx("ml-auto pl-2 text-gray-400 text-sm dark:text-gray-600")}>{hint}</span>
    )}
    {shortcut && (
      <span className={cx("ml-auto pl-2 text-gray-400 text-sm dark:text-gray-600")}>
        {shortcut}
      </span>
    )}
  </DropdownMenuPrimitives.Item>
...
const DropdownMenuCheckboxItem = forwardRef<
  ComponentRef<typeof DropdownMenuPrimitives.CheckboxItem>,
  Omit<ComponentPropsWithoutRef<typeof DropdownMenuPrimitives.CheckboxItem>, "asChild"> & {
    shortcut?: string;
    hint?: string;
  }
>(({ className, hint, shortcut, children, checked, ...props }, forwardedRef) => (
  ...
  >
    ...
    {children}
    {hint && (
      <span className={cx("ml-auto font-normal text-gray-400 text-sm dark:text-gray-600")}>
        {hint}
      </span>
    )}
    {shortcut && (
...
const DropdownMenuRadioItem = forwardRef<
  ComponentRef<typeof DropdownMenuPrimitives.RadioItem>,
  Omit<ComponentPropsWithoutRef<typeof DropdownMenuPrimitives.RadioItem>, "asChild"> & {
    shortcut?: string;
    hint?: string;
  }
...
const DropdownMenuLabel = forwardRef<
  ComponentRef<typeof DropdownMenuPrimitives.Label>,
  ComponentPropsWithoutRef<typeof DropdownMenuPrimitives.Label>
...
const DropdownMenuSeparator = forwardRef<
  ComponentRef<typeof DropdownMenuPrimitives.Separator>,
  ComponentPropsWithoutRef<typeof DropdownMenuPrimitives.Separator>
>(({ className, ...props }, forwardedRef) => (
...
const DropdownMenuIconWrapper = ({ className, ...props }: HTMLAttributes<HTMLSpanElement>) => {
  return (
    <div
      className={cx(
        // text color
